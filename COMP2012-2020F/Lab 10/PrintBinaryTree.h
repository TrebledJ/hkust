#ifndef PRINTBINARYTREE_H
#define PRINTBINARYTREE_H
...
template<class T>
void print_tree(BtreeNode<T> *root, int level, int indentSpace, std::ostream &out) {
    int h = tree_height(root)+1;
...
template<class T>
void print_tree(BtreeNode<T> *root) {
    print_tree(root, 1, 0, std::cout);
}

#endif //PRINTBINARYTREE_H
