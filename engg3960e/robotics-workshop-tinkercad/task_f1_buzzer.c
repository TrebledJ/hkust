// 
//  task_f1_buzzer.c (F1 Lights with Buzzer!)
...
#ifdef ENABLE_BUZZER
//  Use the special `tone` function which accepts three parameters:
//    * pin
//    * frequency (Hz)
//    * duration (ms). This parameter is optional.
#define beep() tone(BUZZER, 220, 100)
#define beepGo() tone(BUZZER, 330, 500)
#else
#define beep()
#define beepGo()
#endif
